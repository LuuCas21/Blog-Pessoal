...
const changeMode = function(sheet) {
    document.querySelector('#theme').setAttribute('href', sheet);
    sessionStorage.setItem('dark', sheet);
}

changeMode(sessionStorage.getItem('dark') || '/styles/default.css');
...
icon.addEventListener('mouseover', handleHover.bind(0.5));
icon.addEventListener('mouseout', handleHover.bind(1));
*/